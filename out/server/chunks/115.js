...
const Logo = ({ src  })=>{
    ...
    const { base_url , logo , logo_width , logo_height , logo_text , title  } = config/* site */.lz;
    return /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
        ...
        children: src || logo ? /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
...
const Header = ()=>{
    ...
    // logo source
    const { logo  } = config/* site */.lz;
    const { enable , label , link  } = config/* nav_button.0 */.Hl[0];
...
module.exports = JSON.parse('{"lz":{"title":"Taimi landing page","base_url":"/","favicon":"/images/dision_tech.svg","logo":"/images/dision_logo_black.svg","logo_width":"160","logo_height":"48","logo_text":"Distion Tech"},"Xd":{"pagination":4,"summary_length":200,"blog_folder":"blogs"},"Hl":[{"enable":true,"label":"Get a demo","link":"/#"}],"f":{"contact_form_action":"","tag_manager_id":"","footer_content":"Lorem ipsum dolor sit amet, consectetur elit. Consjat tristique eget amet, tempus eu at cttur.","copyright":"Designed and Developed by [dision.tech](https://dision.tech/)"},"Pu":{"meta_author":"Themefisher","meta_image":"","meta_description":"A SAAS template for nextjs"}}');
...
module.exports = JSON.parse('{"main":[{"name":"Features","url":"#"},{"name":"Why choose use?","url":"#"},{"name":"Download","url":"#"}],"footer":[{"name":"Company","menu":[{"text":"Pricing","url":"/pricing"},{"text":"Quick Start","url":"#"}]},{"name":"Product","menu":[{"text":"Features","url":"#"},{"text":"Platform","url":"#"},{"text":"Pricing","url":"/pricing"}]},{"name":"Support","menu":[{"text":"FAQ","url":"#"},{"text":"Privacy Policy","url":"#"},{"text":"Terms & Conditions","url":"#"}]}]}');
